        ...
        <div>
            ...
            <!-- cards -->
                <div class="card relative">
                    <img src="img/default3.jpg" alt="image" class="w-full h-35 sm:h-48 object-cover">
                    <div class="text-center mt-1">
                        <span class="font-bold">Blackberry</span>
                        <span class="block text-gray-500 text-sm">Price - $600</span>
                    </div>
                    ...
                    <div class="m-2 flex justify-evenly">
                        ...
                        <button @click="onClick" class="rounded-full py-1 px-2 text-xs font-bold cursor-pointer tracking-wider border-gray-500 md:border-2 text-gray hover:bg-gray-500 hover:text-white transition ease-out duration-500">
